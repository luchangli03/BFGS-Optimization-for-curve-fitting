...
class BFGSOptimizer_TypeDef {
 ...
 public:
  ...
  BFGSOptimizer_TypeDef(void(* ipPreFitting)(float* FitPara, IType* DataArrayList[DataArrayNum], int DataNum),
                        float(* ipTargerF)(float* FitPara, IType* DataArrayList[DataArrayNum], int DataNum)) {
    int cnt;
